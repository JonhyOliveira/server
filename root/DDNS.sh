#!/usr/bin/env bash
# based on https://raw.githubusercontent.com/daniel-boctor/Daniel-Boctor-Youtube/refs/heads/main/Namecheap%20DDNS%20Script/DDNS.sh

domain="joaooliveira.xyz"
api_key=$(cat DDNS_password.txt)
hosts=("" "www." "*." "house.")
